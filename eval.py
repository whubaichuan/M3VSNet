...
parser.add_argument('--photo_threshold', type=int, default=0.8, help='photo_threshold')
...
parser.add_argument('--outdir', default='./outputs/DTU', help='output dir')
...
def filter_depth(scan_folder, out_folder, plyfilename):
    ...
    for ref_view, src_views in pair_data:
        ...
        #print(ref_img.shape)
        #print(ref_depth_est.shape)
        confidence = read_pfm(os.path.join(out_folder, 'confidence/{:0>8}.pfm'.format(ref_view)))[0]
        #print(args.photo_threshold)
